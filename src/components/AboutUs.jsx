...
const AboutUs = () => {
    return (
        <div className="h-auto w-full p-4 bg-primary absolute xs1:grid xs1:grid-cols-1 xs1:gap-x-4 xs1:gap-y-24 xs1:justify-around xs1:row-span-16 xs1:place-content-evenly">
            <div className="h-[400px] w-full flex flex-row xs1:flex-col-reverse m-4 xs1:mx-4 xs1:my-16 xs1:py-16 relative xs1:top-80">
                <img className="h-[400px]  w-[400px]  mx-16 my-4  p-8" src={droneframe} alt="" />
                <div className="h-[400px]  w-[600px] xs1:w-[90vw] mx-16 my-4 xs1:m-4 p-8 xs1:p-2 absolute xs1:relative right-10 xs1:right-0">
            ...
            <div className="h-[400px] w-full flex flex-row xs1:flex-col m-4 xs1:mx-4 xs1:my-16 relative xs1:py-16">
                <div className="h-[400px]  w-[600px] xs1:w-[90vw] mx-16 my-4 xs1:m-4 p-8 xs1:p-2 right-10 xs1:right-0 ">
                ...
                <img className="h-[400px] w-[400px] mx-16 my-4 p-8 md:absolute md:right-10" src={planeframe} alt="" />
            </div>

            <div className="h-[600px] xs1:h-[1000px] w-full flex flex-row xs1:flex-col-reverse m-4 xs1:mx-4 xs1:mb-16 xs1:mt-48 xs1:pt-32">
                <img className="h-[400px] w-[400px] mx-16 my-4 xs1:my-0 p-8 relative left-10 xs1:left-0 " src={droneframe} alt="" />
                <div className="h-[600px]  w-[600px] xs1:w-[90vw] mx-16 my-4 xs1:mx-4 xs1:my-0 p-8 xs1:p-2 right-10 xs1:right-0 ">
            ...
            <img className="h-[400px] w-[400px] mx-16 my-4 p-8 " src={planeframe} alt="" />
                <div className="h-[400px]  w-[600px] xs1:w-[90vw] mx-16 my-4 xs1:mx-4 p-8 xs1:p-2 left-10 xs1:left-0 md:absolute">
