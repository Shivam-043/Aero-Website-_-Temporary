    ...
    return (
        <div className="h-auto w-full p-4 bg-primary absolute xs1:grid xs1:grid-cols-1 xs1:gap-x-4 xs1:gap-y-24 xs1:justify-around xs1:row-span-16 xs1:place-content-evenly">
            <div className="h-[400px] w-full flex flex-row xs1:flex-col-reverse m-4  xs1:py-16 relative xs1:top-80">
                <img className="sm:h-[400px] h-[300px] sm:w-[400px] w-[300px] sm:mx-16 my-4  p-8" src={droneframe} alt="" />
            ...
            <div className="h-[400px] w-full flex flex-row xs1:flex-col m-4 xs1:mx-0 xs1:my-16 relative xs1:py-16 ">
                <div className="h-[400px]  w-[600px] xs1:w-[90vw] mx-16 my-4 xs1:m-4 p-8 xs1:p-2 right-10 xs1:right-0 xs1:mx-0">
                    ...
                    <p className="text-xl py-1 poppins sm:pl-16">Our club was founded in 2007 by Kamal Kant Gaur and co-founded by flying enthusiasts Dipesh, Rupesh, and Suman. Under the able guidance of Dr. G.L. Pahuja, the club has come a long way since then. We have a strong track record of success in competitions, and our events are always popular at the college's annual techfest, Techspardha.</p>
                </div>
                <img className="sm:h-[400px] h-[300px] sm:w-[400px] w-[300px] sm:mx-16 mx-8 my-4 p-8 md:absolute md:right-10 xs1:mx-0" src={planeframe} alt="" />
            </div>

            <div className="h-[600px] xs1:h-[1000px] w-full flex flex-row xs1:flex-col-reverse m-4 xs1:mx-4 xs1:mb-16 xs1:mt-48 xs1:pt-32">
                <img className="sm:h-[400px] h-[300px] w-[300px] sm:w-[400px] sm:mx-16 mx-8 my-4 xs1:my-0 p-8 relative left-10 xs1:left-0 xs1:top-20 xs1:mx-0 " src={droneframe} alt="" />
                <div className="h-[600px]  w-[600px] xs1:w-[90vw] mx-16 my-4 xs1:mx-0 xs1:my-0 p-8 xs1:p-2 right-10 xs1:right-0 ">
            ...
            <img className="sm:h-[400px] sm:w-[400px] h-[300px] w-[300px] sm:mx-16 mx-8 my-4 p-8 xs1:mx-0" src={planeframe} alt="" />
