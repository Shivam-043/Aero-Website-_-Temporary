...
const SeniorCard = (props) => {
  return (
    <div className="xl:w-1/3 sm:w-3/4 md:w-2/5 relative mt-16 mb-32 sm:mb-24 xl:max-w-sm lg:w-2/5 bg-black-gradient-2 ">
      ...
      <div className="px-6 mt-16">
        ...
        <div className="w-full flex justify-center pt-5 pb-5">
          ...
          <a target={"_blank"} href={props.insta} className="mx-5">
            <div>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
