...
const ContactUs = () => {
  ...
  return (
    ...
    //     <h1 className="text-white font-bold text-[78px] font-poppins">
    //       Contact Us
    //     </h1>
    ...
    <div className="px-5">
            ...
            <div class="container px-5 py-20 mx-auto flex-col">
                ...
                <div class="lg:w-1/2 md:w-2/3 mx-auto">
                    <div class="flex flex-wrap -m-2">
                        <div className="flex justify-center items-center mx-auto gap-x-8 mt-6">
                            ...
                            <a target={'_blank'} href='tel: ' type='' className='sm:hidden'>
