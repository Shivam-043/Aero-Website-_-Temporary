...
const Faqs = () => {
  return (
    <div className="faq container-faqs" aria-level="Frequently Asked Questions">
  ...
  return (
    <>
      <details aria-expanded="true" className="faq__panel" open >
           ...
           <div className="faq__panel-body">
           <p className="faq__panel-answer">{answer}</p>
           </div>
       </details>
    </>
  )
