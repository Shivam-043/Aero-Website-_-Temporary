  ...
  return (
    <div className="bg-primary relative">
        ...
        <div className="relative">
          ...
          <div className="relative">
            ...
            <div className="flex absolute bottom-[6vh] left-5 ">
                <h3 className=" text-white font-poppins text-[20px] mr-5 xs1:mr-3 xs1:text-[15px]">25 Jun 2021</h3>
                <h3 className=" text-white font-poppins text-[20px] xs1:text-[15px]"> Cosmos</h3>
            </div>
      ...
      <div className="Introduction flex ">
        <p className="w-1/6 blog-section-text xs1:pt-[10vh] md1:blog-section-text-lg text-[20px] font-bold">
          Introduction
        </p>
        <p class=" w-3/4 first-word-uppercase-p text-white font-poppins xs1:my-3 font-normal text-[15px] xs1:mx-5">
      ...
      <div className="Introduction flex">
        <p className="w-1/6 blog-section-text pt-[10vh] text-[20px] font-bold">
          Content
        </p>
      ...
      <div className="justify-items-center grid">
        <div className="Author_Detail h-[10vh] pt-5 mb-5 flex-row flex justify-around mt-5 bg-black-gradient w-[90vw] rounded-lg">
        <p className="text-white">Add to Wishlist</p>
        <div onClick={handleWishlistClick}>
          {isInWishlist ? (
            <svg width="32px" fill="#ffffff" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" stroke="#ffffff"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"><path d="M20.808,11.079C19.829,16.132,12,20.5,12,20.5s-7.829-4.368-8.808-9.421C2.227,6.1,5.066,3.5,8,3.5a4.444,4.444,0,0,1,4,2,4.444,4.444,0,0,1,4-2C18.934,3.5,21.773,6.1,20.808,11.079Z"></path></g></svg>
          ) : (
        <svg width="32px" fill="#ff0d13" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" stroke="#ff0d13"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"><path d="M20.808,11.079C19.829,16.132,12,20.5,12,20.5s-7.829-4.368-8.808-9.421C2.227,6.1,5.066,3.5,8,3.5a4.444,4.444,0,0,1,4,2,4.444,4.444,0,0,1,4-2C18.934,3.5,21.773,6.1,20.808,11.079Z"></path></g></svg>
